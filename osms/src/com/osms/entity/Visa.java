...
public class Visa implements Serializable{
	...
	private Date registerDeadline=null;//注册截止时间
	...
	public Visa(int visaId, Date registerDeadline, String intermediary, String intermediaryPhone,
	...
	public String toString() {
		return "Visa [visaId=" + visaId + ", registerDeadline=" + registerDeadline + ", intermediary=" + intermediary
				+ ", intermediaryPhone=" + intermediaryPhone + ", guaranteeName=" + guaranteeName + ", guaranteePhone="
				+ guaranteePhone + ", fundingSourceId=" + fundingSourceId + ", passportId=" + passportId
				+ ", approvalTime=" + approvalTime + ", visaDueTime=" + visaDueTime + ", passport=" + passport
